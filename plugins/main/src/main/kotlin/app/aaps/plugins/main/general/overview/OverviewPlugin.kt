    ...
    override fun addPreferenceScreen(preferenceManager: PreferenceManager, parent: PreferenceScreen, context: Context, requiredKey: String?) {
        ...
        category.apply {
            ...
            addPreference(preferenceManager.createPreferenceScreen(context).apply {
                ...
                addPreference(AdaptiveDoublePreference(ctx = context, doubleKey = DoubleKey.OverviewInsulinButtonIncrement1, dialogMessage = app.aaps.core.keys.R.string.insulin_increment_button_message, title = app.aaps.core.keys.R.string.pref_title_insulin_button_increment_1))
                addPreference(AdaptiveDoublePreference(ctx = context, doubleKey = DoubleKey.OverviewInsulinButtonIncrement2, dialogMessage = app.aaps.core.keys.R.string.insulin_increment_button_message, title = app.aaps.core.keys.R.string.pref_title_insulin_button_increment_2))
                addPreference(AdaptiveDoublePreference(ctx = context, doubleKey = DoubleKey.OverviewInsulinButtonIncrement3, dialogMessage = app.aaps.core.keys.R.string.insulin_increment_button_message, title = app.aaps.core.keys.R.string.pref_title_insulin_button_increment_3))
                ...
                addPreference(AdaptiveIntPreference(ctx = context, intKey = IntKey.OverviewCarbsButtonIncrement1, dialogMessage = app.aaps.core.keys.R.string.carb_increment_button_message, title = app.aaps.core.keys.R.string.pref_title_carbs_button_increment_1))
                addPreference(AdaptiveIntPreference(ctx = context, intKey = IntKey.OverviewCarbsButtonIncrement2, dialogMessage = app.aaps.core.keys.R.string.carb_increment_button_message, title = app.aaps.core.keys.R.string.pref_title_carbs_button_increment_2))
                addPreference(AdaptiveIntPreference(ctx = context, intKey = IntKey.OverviewCarbsButtonIncrement3, dialogMessage = app.aaps.core.keys.R.string.carb_increment_button_message, title = app.aaps.core.keys.R.string.pref_title_carbs_button_increment_3))
            ...
            addPreference(AdaptiveIntPreference(ctx = context, intKey = IntKey.OverviewResetBolusPercentageTime, dialogMessage = app.aaps.core.keys.R.string.deliver_part_of_boluswizard_reset_time, title = app.aaps.core.ui.R.string.partialboluswizard_reset_time))
            addPreference(AdaptiveSwitchPreference(ctx = context, booleanKey = BooleanKey.OverviewUseBolusAdvisor, summary = app.aaps.core.keys.R.string.pref_summary_use_bolus_advisor, title = app.aaps.core.keys.R.string.pref_title_use_bolus_advisor))
            addPreference(AdaptiveSwitchPreference(ctx = context, booleanKey = BooleanKey.OverviewUseBolusReminder, summary = app.aaps.core.keys.R.string.pref_summary_use_bolus_reminder, title = app.aaps.core.keys.R.string.pref_title_use_bolus_reminder))
            addPreference(preferenceManager.createPreferenceScreen(context).apply {
                key = "overview_advanced_settings"
